...
public class ReflectDataMapper implements DataMapper
{
    private Instant valueToInstant(Object value)
    {
        if (value == null) {
            return null;
        }
    ...
    private Object stringToType(Class<?> clazz, String value)
    {
    ...
    private <T> T mapSingleRow(Class<T> clazz, JsonObject row) throws IllegalAccessException, InstantiationException
    {
    ...
    private Object convertSQLArrayToJavaArray(Class<?> arrayComponentType, String sqlArrayAsString)
    {
    ...
    private <T> T[] convertJsonArrayToJavaArray(Class<T> arrayComponentType, String jsonArrayAsString)
    {
